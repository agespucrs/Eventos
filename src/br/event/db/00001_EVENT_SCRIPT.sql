...
--changeset cassio:1
--comment Script para cria��o das tabelas do projeto.
/***
...
INSERT INTO `TB_EVENTO` (ID_EVENTO,NOME,SIGLA,DESCRICAO,DT_INICIO,DT_FIM,DT_CADASTRO,DT_ALTERACAO) VALUES (1,'XXXVI Congresso da Sociedade Brasileira de Computação','CSBC 2016','A Computação é uma área em constante evolução, que se constitui em um elemento estratégico para o crescimento econômico e social de todos os países. Por isso, requer planejamento, investimento e intensificação da formação de profissionais qualificados para atender às demandas da sociedade.
...
INSERT INTO `TB_SUB_EVENTO` (ID_SUB_EVENTO,ID_EVENTO,NOME,SIGLA,DESCRICAO,DT_INICIO,DT_FIM,DT_CADASTRO,DT_ALTERACAO) VALUES (8,1,'WCAMA 2016 – VII Workshop de Computação Aplicada à Gestão do Meio Ambiente e Recursos Naturais','WCAMA','O workshop abrange toda as áreas de pesquisas e aplicações em metodologias, técnicas e ferramentas computacionais aplicadas à gestão do meio ambiente e dos recursos naturais, incluindo (mas não limitado a):
